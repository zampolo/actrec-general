...
\begin{enumerate}
    ...
    \item Estabelecimento de rede de parcerias envolvendo a academia, a indústria e o setor produtor de \emph{software}, visando a criação de soluções com maturidade tecnológica nível 7 (TRL, Technology Readiness Level), ou seja, demonstração de protótipo em ambiente operacional; %no projeto não permaneçam apenas em âmbito acadêmico, mas possam ser comercializadas e implantadas; 
    % econômicos
