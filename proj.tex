...
% qual a importância para a empresa de dispor de sistemas de segurança
% como os sistemas de reconhecimento de atividades podem ajudar nisso?
% qual o custo associado a acidentes em ambientes industriais ou roubo? Há estimativas nesse sentido? Danos ambientais, indenizações, redução de valores de apólices de seguro obrigatório
% relevância científica do problema, oportunidade de colaboração/estreitamento de parcerias entre  indústria e academia, formação de recursos humanos locais especializados
% Falar mais sobre
%  MANUFATURA AVANÇADA
%  INDÚSTRIA 4.0
%  Usar os termos dos artigos consultados: redução de custos e aumento da produtividade
% Brasil registrou 500k cados de acidentes de trabalho, segundo a AEPS (Anuário estátístico da Previdência Social): quanto isso dá em R$?
% investimento inteligente de recursos, economizar insumos , atuar de maneira ativa na prevenção
% maior produtividade, redução de paradas para manutenção e reposição
% EPI e EPColetiva, detecção de fogo, indicadores (número de situações de risco potencial)
% uso de drones.
% Entre 2012 e 2016, foram gastos mais de R$ 20 bilhões dos fundos da Previdência com benefícios para trabalhadores acidentados. Inclusive, calcula-se que, a cada 47 segundos, ocorre um acidente de trabalho no Brasil ( Observatório Digital de Saúde e Segurança do Trabalho).
% Os acidentes de trabalho têm um profundo impacto na economia, nas políticas públicas, na indústria e, principalmente, no trabalhador e seus familiares.
% Associação Nacional dos Procuradores do Trabalho (ANPT), o Brasil registrou em 2015 cerca de 704 mil casos, que resultaram em 3 mil mortes. Esses acidentes têm custado aos cofres públicos mais de R$10 bilhões por ano, gastos em indenizações e tratamentos de saúde.
% Em casos de morte do empregado, a situação fica ainda mais grave. Se a responsabilidade do empregador for atestada, ele deverá arcar com os gastos emergentes, ou seja, aqueles relacionados a tratamentos médicos, despesas com hospital e funeral, entre outros. Isso tudo sem falar na indenização que deve ser paga aos dependentes e herdeiros.
%Todos esses custos se refletem na economia de uma forma geral. Com efeito, os gastos com acidentes de trabalho que recaem sobre a empresa acabam sendo repassados ao consumidor. Isso faz com que, em um cenário de grande concorrência, a companhia perca seu potencial competitivo no mercado.
%
% Tipos de acidentes : típicos (em local de trabalho em horário de expediente) e atípicos ()
