...
\begin{enumerate}
	\item Impacto tecnológico:
		...
		\begin{enumerate}
			\item Desenvolvimento de 2 produtos: software para reconhecimento de atividades; e aplicativos web/mobile para consulta a relatórios aos dados monitorados.
			\item Registro de 2 softwares: 1) Aplicativo e 2) sistema web para visualização de relatórios para monitoramento remoto de atividades; 
	...
	\item Impacto econômico:
		...
		\begin{enumerate}
			\item Redução de custos associados ao tratamento de lesões provenientes de quedas e outros tipo de acidentes em pessoas idosas
			\item Redução de gastos por cuidados de pessoa em condição degenerativa decorrente do envelhecimento, evitáveis mediante intervenção precoce.
			\item Aumento de competitividade das empresas de assistência ao idoso ou de cuidadores: decorre da oferta de um serviço de boa qualidade e um preço menor.
			\item Aumento do volume de negócios do mercado de tecnologia, informática e comunicação local e regional: a solução proposta consiste em diferentes produtos de software (sistema de análise, aplicativo, sistema web). Contudo, haverá necessidade de instalação de recursos para: aquisição de vídeo (câmeras, servidores); comunicação de dados (modem, provedores de acesso); e armazenamento e processamento (servidores de vídeo, processadores de alta capacidade)
		\end{enumerate}
	\item Impacto ambiental:
		...
		\begin{enumerate}
			\item Não há risco ambiental direto: o desenvolvimento ou uso do sistema proposto não produzem substâncias tóxicas ou de efeito contaminante para o ambiente.
		\end{enumerate}
	\item Impacto social:
		...
		\begin{enumerate}
			\item Melhoria da qualidade de vida e  autonomia de pessoas idosas, pessoas com deficiência motora. : auxiliada pela manutenção de um sistema de monitoramento de parâmetros de movimento que possam auxiliar no acompanhamento e intervenção precoce de doenças degenerativas associadas ao envelhecimento. 
		\end{enumerate}
\end{enumerate}
