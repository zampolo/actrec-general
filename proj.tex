...
A razão de ser desta proposta apresenta-se sob dois enfoques. Um deles, acadêmico: redes neurais profundas aplicadas à interpretação automática de imagens ou vídeos é um tópico de grande interesse na comunidade científica. Mais especificamente, o reconhecimento de atividades humanas em ambientes reais ganha cada vez mais espaço em conferências e publicações especializadas em decorrência dos resultados promissores alcançados com proposições de novas arquiteturas, estratégias de treinamento e transferência de conhecimento em aprendizagem profunda, e disponibilidade cada vez maior tanto de sistemas de captura com recursos de acesso a redes de comunicação, quanto de unidades de armazenamento de alta capacidade. Considerável esforço é atualmente empregado na modelagem temporal de ações sucessivas que formam atividades complexas, caracterização entre pessoas e objetos em uma cena, e no aumento de accurácia quando o ambiente em que o monitoramento ocorre é complexo e dinâmico.

O segundo enfoque, contudo, possui grande relevância e constitui a principal motivação deste projeto: segurança e proteção em ambientes industriais. O tema possui importância evidente, pois impacta em um número muito grande de elementos, dentre os quais, a integridade física e psicológica dos colaboradores da indústria, produtividade das empresas, e pegada ambiental. Apesar da indução de políticas pela legislação específica para o assunto e da crescente adesão das organizações, estima-se que mais de R\$ 20 bilhões dos fundos da Previdência Social foram gastos com benefícios (indenizações e tratamentos de saúde) para trabalhadores acidentados entre 2012 e 2016. A Associação Nacional dos Procuradores do Trabalho (ANPT), indica que em 2015 o Brasil registros aproximadamente 704.000 acidentes com 3.000 mortes. Tais acidentes trazem consequências negativas para a economia em geral, para a empresa, e, principalmente, para o trabalhador e seus familiares. Em setores de grande concorrência, os custos associados a acidentes laborais pode acarretar expressiva redução do potencial competitivo da empresa.  

Os sistemas de reconhecimento de atividades humanas fazem uso de técnicas de inteligência computacional e oferecem uma camada de proteção a mais aos protocolos já implementados pela equipe de segurança de uma empresa. Tais sistemas podem ser usados como apoio às inspeções de segurança regulares e também nas ações de conscientização sobre a importância do uso de equipamento de proteção individual (EPI) e coletiva (EPC), e o valor no manuseio correto de equipamentos. Se o sistema de monitoramento for equipado com câmeras providas de sensores térmicos, avaliações sistemáticas de temperatura podem auxiliar na prevenção de incêncios. Câmeras embarcadas em drones oferecem ainda mais segurança, permitindo a verificação de áreas e equipamentos de difícil acesso ou de grande risco aos trabalhadores.

A integração de recursos de inteligência computacional na atividade industrial alinha-se com os movimentos de transformação digital e Indústria 4.0, para economizar insumos, aumentar produtividade e competitividade, prevenção ativa de acidentes, e redução para paradas para manutenção reativa e reposição de peças e equipamentos utilizados incorretamente. 
